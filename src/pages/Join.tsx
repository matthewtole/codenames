              ...
              <div className={COLUMNS.INSTRUCTIONS}>
                <div className="box">
                  ...
                  <p className="text">
                    ...
                    players will be looking at, perhaps an Amazon Fire Stick or
                    a laptop connected to a TV.
                  </p>
                  <p className="text">
                    To join a game, you'll need the six-digit code! You can
                    generate one from the game screen, detailed instructions on
                    how to do that are on the <Link to="/help">Help page.</Link>
                  </p>
