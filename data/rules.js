...
module.exports = {
  default: {
    ...
    CIVILIAN: 'It is now the {% other_team %} team\'s turn.',
  ...
  drinking: {
    ...
    CIVILIAN: 'The {% other_team %} spymaster gets to nominate a member of the {% team %} team to take a drink!',
  ...
  strip: {
    ...
    CIVILIAN: 'The {% other_team %} spymaster gets to nominate a member of the {% team %} team to remove one item of clothing!',
